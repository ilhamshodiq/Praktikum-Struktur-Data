...
public class TreeApp {
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            System.out.print("Enter first letter of show, " + "insert, find, delete, minumum, maximum or traverse: ");
            int choice = getChar();
            switch (choice) {
                case 's':
                    theTree.displayTree();
                ...
                case 't':
                    ...
                    break;
                case 'm':
                    System.out.println("Minimum value is : " + theTree.getMIn());
                    break;
                case 'x':
                    System.out.println("Maximum value is : " + theTree.getMax());
                    break;
                default:
